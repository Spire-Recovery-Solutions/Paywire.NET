...
public class TransactionHeader
{
    ...
    /// </summary>
    public string PWKEY { get; set; } = string.Empty;
    /// <summary>
    /// Authentication username provided by the administrator
    /// </summary>
    public string PWUSER { get; set; } = string.Empty;
    /// <summary>
    /// Authentication password provided by the administrator
    /// </summary>
    public string PWPASS { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string PWTRANSACTIONTYPE { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string CARDPRESENT { get; set; } = string.Empty;
    /// <summary>
    /// Show the search result in XML or escaped XML (TRUE or FALSE)
    /// </summary>
    public string XOPTION { get; set; } = string.Empty;
    /// <summary>
    /// Periodic Plan ID
    /// </summary>
    ...
    /// </summary>
    public string PWAPPROVALURL { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string PWDECLINEURL { get; set; } = string.Empty;
    /// <summary>
    /// Processes an Authorization only when a value of TRUE is submitted
    /// </summary>
    public string AUTHONLY { get; set; } = string.Empty;
    /// <summary>
    /// Must set to TRUE for China UnionPay transactions
    /// </summary>
    public string ISCUP { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string NONSECUREPLUS { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string DISABLECF { get; set; } = string.Empty;
    /// <summary>
    ...
    /// </summary>
    public string PWRECEIPTDESC { get; set; } = string.Empty;
    /// <summary>
    /// Paywire cashier identifier.
    /// </summary>
    public string PWCASHIERID { get; set; } = string.Empty;
}
